#!/usr/bin/env bash
# setup.sh — interactive installer for niri-celestia-sddm

set -e
THEME_NAME="niri-celestia-sddm"
...
echo ""
echo -e "${CYAN}${BOLD}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo -e "${CYAN}${BOLD}  niri-celestia-sddm installer${NC}"
echo -e "${CYAN}  SDDM theme matching Celestia-Shell lockscreen${NC}"
echo -e "${CYAN}${BOLD}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo ""
...
echo "  1) Shell Integrate — pull colors directly from Celestia-Shell state (recommended)"
...
if [[ "$MODE_CHOICE" == "1" ]]; then
    ...
    sudo -u "$REAL_USER" "$CONFIG_DIR/shell-sync.sh" || \
        warn "Sync script failed — check if shell scheme exists at ~/.local/state/Celestia/Shell/scheme.json"
    ...
    if [[ -f "$MATUGEN_CONF" ]]; then
        if ! grep -q "celestia-sddm" "$MATUGEN_CONF"; then
