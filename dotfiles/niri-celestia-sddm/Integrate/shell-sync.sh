...
# shell-sync.sh — syncs SDDM colors and wallpaper with Celestia-Shell state
# Pulls from ~/.local/state/Celestia/Shell/scheme.json and ~/.local/state/Celestia/Shell/wallpaper/path.txt
...
STATE_DIR="$USER_HOME/.local/state/Celestia/Shell"
CONFIG_DIR="$USER_HOME/.config/niri-celestia-sddm"
