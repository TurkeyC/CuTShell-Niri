#!/usr/bin/env bash
# test.sh — preview niri-celestia-sddm without locking your session
...
usage() {
cat << HELP
${BOLD}niri-celestia-sddm test runner${NC}
...
if [[ -z "$WALLPAPER" ]]; then
    ...
    WP_HINT="$HOME/.config/niri-celestia-sddm/Colors.qml"
    if [[ -f "$WP_HINT" ]]; then
...
TMP_THEME=$(mktemp -d /tmp/celestia-sddm-test.XXXXXX)
cp -r "$THEME_DIR/." "$TMP_THEME/"

# Copy user config if available
CONFIG_DIR="$HOME/.config/niri-celestia-sddm"
...
# ── Run Greeter ───────────────────────────────────────────────────────────
echo -e "${CYAN}${BOLD}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo -e "${BOLD}  niri-celestia-sddm — Qt6 Test Mode${NC}"
echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
